...
namespace RawPrint
{
    internal class SafePrinter : SafeHandleZeroOrMinusOneIsInvalid 
    {
        ...
        // modified by Jos Schaars for default printer
...
// Jos Schaars
            if (printerName.Length == 0)
                {
                int pLen = 512;
                StringBuilder pName = new StringBuilder(pLen);
                NativeMethods.GetDefaultPrinter(pName, ref pLen); 
                printerName = pName.ToString();
                }
